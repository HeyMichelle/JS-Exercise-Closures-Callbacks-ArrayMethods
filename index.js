...
function getFullNames(runners) {
  ...
  // I would just like a rundown of the syntax and arrow function used in the answer above


    // const fullName = [];
    // for (let i = 0; i < runners.length; i++) {
    //   let mapName = {};
    //   last.runners = runners[i].last_name;
    //   first.runners = runners[i].first_name;
    //   fullName.push(mapName);
    //   mapName = {};
    // }
